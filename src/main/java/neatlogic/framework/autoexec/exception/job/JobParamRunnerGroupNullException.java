...
public class JobParamRunnerGroupNullException extends ApiRuntimeException {
    ...
    public JobParamRunnerGroupNullException(Object key) {
        super("nfaej.jobparamrunnergroupnullexception.jobparamrunnergroupnullexception", key);
    }
}
