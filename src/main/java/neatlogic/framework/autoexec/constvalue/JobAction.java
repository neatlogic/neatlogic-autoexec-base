...
public enum JobAction {
    FIRE("fire", "enum.autoexec.jobaction.fire"),
    PAUSE("pause", "enum.autoexec.jobaction.pause"),
    ...
    REFIRE_NODE("refireNode", "enum.autoexec.jobaction.refire_node"),
    REFIRE_PHASE("refirePhase", "enum.autoexec.jobaction.refire_phase"),
    REFIRE("refireAll", "enum.autoexec.jobaction.refire"),
    ...
    GET_NODE_OUTPUT_PARAM("getNodeOutputParam", "enum.autoexec.jobaction.get_node_output_param"),
    GET_NODE_OPERATION_INPUT_PARAM("getNodeOperationInputParam", "enum.autoexec.jobaction.get_node_operation_input_param"),
    SUBMIT_NODE_WAIT_INPUT("submitNodeWaitInput", "enum.autoexec.jobaction.submit_node_wait_input"),
    ...
    DOWNLOAD_CONSOLE_LOG("downloadConsoleLog", "enum.autoexec.jobaction.download_console_log"),
