...
@ResourceType(name = "scence_os_softwareservice_env_appmodule_appsystem", label = "nmar.resource.ossoftwareenvironmentapplication", moduleId= "autoexec")
public class OsSoftwareServiceEnvAppModuleAppSystemVo {
    ...
    @EntityField(name = "nfad.ossoftwareserviceenvappmoduleappsystemvo.entityfield.envseqno.name", type = ApiParamType.INTEGER)
