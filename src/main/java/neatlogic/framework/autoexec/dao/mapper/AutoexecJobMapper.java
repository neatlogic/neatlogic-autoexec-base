...
public interface AutoexecJobMapper {
    ...
    List<AutoexecJobPhaseVo> getJobPhaseListWithGroupAndRunnerByJobId(Long jobId);
    ...
    List<AutoexecJobPhaseVo> getJobPhaseListWithGroupAndRunnerByJobIdAndPhaseIdList(@Param("jobId") Long jobId, @Param("jobPhaseIdList") List<Long> jobPhaseIdList);
    ...
    List<AutoexecJobPhaseNodeVo> getJobPhaseNodeListByJobIdAndPhaseIdAndExceptStatus(@Param("phaseId") Long phaseId, @Param("exceptStatus") List<String> exceptStatus);
    ...
    int getJobPhaseNodeCountWithoutDeleteAndInvalidByJobIdAndPhaseId(@Param("jobId") Long jobId, @Param("phaseId") Long phaseId);
    ...
    List<AutoexecJobPhaseOperationVo> getJobPhaseOperationListWithVersionAndParentByJobIdAndPhaseId(@Param("jobId") Long jobId, @Param("phaseId") Long phaseId);
