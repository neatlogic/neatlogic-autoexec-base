...
public interface AutoexecJobMapper {
    ...
    List<Long> getSqlDetailIdByJobIdAndPhaseNameAndResourceIdAndLcd(@Param("jobId") Long jobId, @Param("resourceId") Long resourceId, @Param("phaseName") String phaseName, @Param("lcd") Date lcd);
